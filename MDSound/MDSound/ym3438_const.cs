...
namespace MDSound
{
    public class ym3438_const
    {
        ...
        // note table
        public static int[] fn_note = new int[16] { 0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 3, 3, 3, 3, 3, 3 };

        // Env Gen
        public static int[,] eg_stephi = new int[4, 4]{
            { 0, 0, 0, 0 },
            { 1, 0, 0, 0 },
            { 1, 0, 1, 0 },
            { 1, 1, 1, 0 }
        ...
        // Phase Gen
        public static int[] pg_detune = new int[8] { 16, 17, 19, 20, 22, 24, 27, 29 };

        
        public static int[,] pg_lfo_sh1 = new int[8, 8]{
            { 7, 7, 7, 7, 7, 7, 7, 7 },
            { 7, 7, 7, 7, 7, 7, 7, 7 },
            { 7, 7, 7, 7, 7, 7, 1, 1 },
            { 7, 7, 7, 7, 1, 1, 1, 1 },
        ...
        public static int[,] pg_lfo_sh2 = new int[8, 8]{
            { 7, 7, 7, 7, 7, 7, 7, 7 },
            { 7, 7, 7, 7, 2, 2, 2, 2 },
            { 7, 7, 7, 2, 2, 2, 7, 7 },
            { 7, 7, 2, 2, 7, 7, 2, 2 },
        ...
        //Address Decod
        public static int[] op_offset = new int[12] {
            0x000, /* Ch1 OP1/OP2 */
            0x001, /* Ch2 OP1/OP2 */
            0x002, /* Ch3 OP1/OP2 */
            0x100, /* Ch4 OP1/OP2 */
        ...
        public static int[] ch_offset = new int[6]
        {
            0x000, /* Ch1 */
            0x001, /* Ch2 */
            0x002, /* Ch3 */
        ...
        public static uint[] lfo_cycle = { 108, 77, 71, 67, 62, 44, 8, 5 };

        public static uint[,,] fm_algorithm = new uint[4, 6, 8] {
                {
